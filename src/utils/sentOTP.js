    ...
    if (purpose === "registration") {
        ...
        <body>
            <div class="container">
                ...
                <a href="${process.env.WEB_DOMAIN}/reset-password/${otp}/${data.token}" class="button" target="_blank">Reset Password</a>
